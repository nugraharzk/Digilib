<div class="box box-info">
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
              <input type="hidden" name="id_koleksi" value="<?=isset($koleksi->id) ? $koleksi->id : ''?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="judul" class="col-sm-2 control-label">Judul</label>

                  <div class="col-sm-10">
                    <input name="judul" type="text" value="<?=isset($koleksi->judul) ? $koleksi->judul : ''?>" class="form-control" id="judul" placeholder="Judul">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="penulis" type="text" value="<?=isset($koleksi->penulis) ? $koleksi->penulis : ''?>" class="form-control" id="penulis" placeholder="Penulis">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi ..."><?=isset($koleksi->deskripsi) ? $koleksi->deskripsi : ''?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?=isset($koleksi->lampiran) ? '<a target="__blank" href="'.site_url('uploads/'.$koleksi->lampiran).'">'.$koleksi->lampiran.'</a>' : ''?>
